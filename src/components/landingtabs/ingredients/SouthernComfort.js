...
function SouthernComfort() {

    const [isLoading, setLoading] = useState(true);
    const [data, setData] = useState([]);

    const getSouthernComfort = async () => {
        try {
            const response = await fetch('https://www.thecocktaildb.com/api/json/v1/1/filter.php?i=southern_comfort');
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.header}>southern comfortin'</Text>
...
module.exports = SouthernComfort;