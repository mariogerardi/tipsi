...
function Egg() {
    ...
    const getEgg = async () => {
        try {
            const response4 = await fetch('https://www.thecocktaildb.com/api/json/v2/9973533/filter.php?i=egg');
            const json4 = await response4.json();
            setData4(json4);
            const response5 = await fetch('https://www.thecocktaildb.com/api/json/v2/9973533/filter.php?i=egg_yolk');
            const json5 = await response5.json();
            setData5(json5);
            const response6 = await fetch('https://www.thecocktaildb.com/api/json/v2/9973533/filter.php?i=egg_white');
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.header}>frothy and eggy</Text>
