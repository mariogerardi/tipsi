...
function FruitPunch() {
    ...
    const getFruitPunch = async () => {
        try {
            const response = await fetch('https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i=178368');
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.header}>punch for big kids</Text>
