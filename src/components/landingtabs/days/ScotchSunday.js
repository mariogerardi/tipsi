...
function Scotch() {
    ...
    const getScotch = async () => {
        try {
            const response = await fetch('https://www.thecocktaildb.com/api/json/v1/1/filter.php?i=scotch');
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.header}>scotch sunday</Text>
